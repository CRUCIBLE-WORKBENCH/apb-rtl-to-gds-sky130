...
# File        : apb_synthesis_with_sky130pdk/06_floorplanning/run_floorplan.ps1
# Created     : 2026-09-07
...
$scriptPath = Join-Path $scriptDir "openroad_floorplan.tcl"

Write-Host "Running OpenROAD floorplan for APB_Protocol"
